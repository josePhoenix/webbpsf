...
Code by Marshall Perrin <mperrin@stsci.edu> and collaborators.
"""
import os
import types
import glob
...
class SpaceTelescopeInstrument(poppy.instrument.Instrument):
    ...
    *Note*: Do not use this class directly - instead use one of the specific instrument subclasses!
    ...
    configuration can be done by editing the :ref:`SpaceTelescopeInstrument.options` dictionary,
    either by passing options to ``__init__`` or by directly editing the dict afterwards.
    """
